ServerEvents.recipes(e => {
  //动力合成器添加：暗淡太空合金
  e.recipes.create.mechanical_crafting('8x kubejs:bleak_space_alloy_ingot', [
    'AABB',
    'ACDB',
    'BEFA',
    'BBAA'
  ...
  e.shapeless('kubejs:bleak_space_block', [
    '9x kubejs:bleak_space_alloy_ingot'
  ])
  e.shapeless('9x kubejs:bleak_space_alloy_ingot', [
    'kubejs:bleak_space_block'
  ])
  //太空合金块合成
  e.shapeless('kubejs:space_block', [
    '9x kubejs:space_alloy_ingot'
  ])
  e.shapeless('9x kubejs:space_alloy_ingot', [
    'kubejs:space_block'
  ])
  //暗淡太空合金充能
  e.custom({
    ...
    ingredients: [
      {
        item: "kubejs:bleak_space_alloy_ingot"
      }
    ],
    results: [
      {
        item: "kubejs:space_alloy_ingot"
      }
    ]
  })
  //暗淡太空合金充能
  ...
  e.recipes.create.sequenced_assembly([
    ...
    Item.of('kuebjs:space_alloy_nugget').withChance(5),
    Item.of('kubejs:overcharged_redstone').withChance(5),
    Item.of('create_new_age:overcharged_diamond').withChance(5),
    Item.of('kubejs:space_alloy_sheet').withChance(5)
  ], 'kubejs:space_alloy_sheet', [
    e.recipes.create.deploying(inter, [inter, 'kubejs:space_alloy_nugget']),
  ...
  //太空合金板合成
  e.recipes.create.pressing('kubejs:space_alloy_sheet', 'kubejs:space_alloy_ingot')
  //太空合金粒合成
  e.shapeless('9x kubejs:space_alloy_nugget', 'kubejs:space_alloy_ingot')
  e.shapeless('kubejs:space_alloy_ingot', '9x kubejs:space_alloy_nugget')
  //暗淡太空合金工具手柄
  e.shaped('kubejs:bleak_space_alloy_handle', [
    ' A ',
    ' A ',
    '   '
  ], {
    A: 'kubejs:bleak_space_alloy_ingot'
  })
  //太空合金稿合成
  e.recipes.create.mechanical_crafting('kubejs:space_alloyed_pickaxe', [
    ...
    A: 'kubejs:space_alloy_sheet',
    B: 'create_new_age:overcharged_diamond',
    C: 'kubejs:space_alloy_ingot',
    D: 'kubejs:bleak_space_alloy_handle',
...
ServerEvents.tags('item', e => {
  ...
  e.add('kjs:bleak_space_alloy_ingot', [
    'kubejs:bleak_space_alloy_ingot', 'kubejs:space_alloy_ingot'
  ])
  e.add('kjs:space_alloy_ingot', 'kubejs:space_alloy_ingot')
  //太空合金物品tag添加
