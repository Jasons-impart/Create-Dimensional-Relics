ServerEvents.recipes(e=>{
  ...
  e.recipes.create.mixing('8x refinedstorage:processor_binding',[
    ...
    Fluid.of('water 10'),
    '#forge:string'
  ]).heated().id('refinedstorage:processor_binding')
  //粗硅合成及其烧练
  e.recipes.create.mixing('4x kubejs:raw_silicon',[
    'minecraft:quartz',
    '3x #minecraft:coals'
  ]).heated().id('rs_kjs:raw_silicon')
  e.recipes.minecraft.smelting('refinedstorage:silicon', 'kubejs:raw_silicon')
  //序列合成：基础处理器
  e.recipes.create.sequenced_assembly('refinedstorage:basic_processor', 'refinedstorage:silicon', [
    ...
    e.recipes.create.deploying('refinedstorage:raw_basic_processor', ['refinedstorage:raw_basic_processor', '#forge:gems/diamond']).keepHeldItem(),
  ...
  e.recipes.create.sequenced_assembly('refinedstorage:improved_processor', 'refinedstorage:basic_processor', [
    ...
    e.recipes.create.deploying('refinedstorage:raw_improved_processor', ['refinedstorage:raw_improved_processor', '#forge:gems/diamond']).keepHeldItem(),
  ...
  e.recipes.create.sequenced_assembly('refinedstorage:advanced_processor', 'refinedstorage:improved_processor', [
    ...
    e.recipes.create.deploying('refinedstorage:raw_advanced_processor', ['refinedstorage:raw_advanced_processor', '#forge:ingots/netherite']).keepHeldItem(),
  ...
  e.recipes.create.sequenced_assembly('refinedstorage:destruction_core', 'refinedstorage:advanced_processor',[
    ...
    e.recipes.create.deploying('refinedstorage:advanced_processor', ['refinedstorage:advanced_processor', 'minecraft:diamond_pickaxe'])
  ]).transitionalItem('refinedstorage:advanced_processor').loops(1).id('refinedstorage:destruction_core')
  //成型核心
  e.recipes.create.sequenced_assembly('refinedstorage:construction_core', 'refinedstorage:improved_processor', [
    ...
    e.recipes.create.deploying('refinedstorage:improved_processor', ['refinedstorage:improved_processor', 'minecraft:gold_ingot'])
  ]).transitionalItem('refinedstorage:improved_processor').loops(1).id('refinedstorage:construction_core')
})