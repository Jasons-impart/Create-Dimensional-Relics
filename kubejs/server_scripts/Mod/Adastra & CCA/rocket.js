BlockCrafting.addMultiblockStructure(MultiblockStructureBuilder.create("tier_1_rocket")
    .pattern("afffa","afffa","fffff","fffff","fffff","fffff","fffff","fffff","fffff")
    .pattern("faaaf","faaaf","faaaf","faaaf","faaaf","facaf","ffaff","fffff","fffff")
    .pattern("faaaf","faaaf","fabaf","fabaf","fafaf","fafaf","fafaf","ffaff","ffdff")
    .pattern("faaaf","faaaf","faeaf","faaaf","faaaf","faaaf","ffaff","fffff","fffff")
    .pattern("afffa","afffa","fffff","fffff","fffff","fffff","fffff","fffff","fffff")
